...
describe('ClipPanel', () => {
  it('previews the captured content and source BEFORE any action (informed consent)', () => {
    render(<ClipPanel settings={DEFAULT_SETTINGS} clip={clip} disabled={false} onClose={() => {}} recentFiles={[]} />)
  ...
  it('gates the flow when not configured (disabled)', () => {
    render(<ClipPanel settings={DEFAULT_SETTINGS} clip={clip} disabled={true} onClose={() => {}} recentFiles={[]} />)
  ...
  it('a screenshot clip shows the image + recognize button (not the target picker yet)', () => {
    ...
    render(<ClipPanel settings={DEFAULT_SETTINGS} clip={shot} disabled={false} onClose={() => {}} recentFiles={[]} />)
  ...
  it('shows a friendly error for an unsupported page', () => {
    render(<ClipPanel settings={DEFAULT_SETTINGS} clip={null} error="此页面不支持剪藏" disabled={false} onClose={() => {}} recentFiles={[]} />)
